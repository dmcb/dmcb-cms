<div class="leftcolumn">
	...
	<form action="<?=base_url();?>wall" method="post" onsubmit="return dmcb.submit(this);">
	...
	<br/>
	<iframe src="http://www.facebook.com/widgets/like.php?href=<?=urlencode(base_url());?>wall" scrolling="no" frameborder="0" style="border:none; width:288px; height:80px"></iframe>
</div>
