	...
	<form action="<?=base_url();?>account/messagesettings" method="post" onsubmit="return dmcb.submit(this);">
		<fieldset>
			...
			<div id="messagesettings" class="panel alwaysopen"><div>
				...
				<div class="formnotes">
					<p>Occasionally there might be updates sent out if you're on the mailing list. You can opt out of this, but you'll still receive any moderation messages.</p>
				</div>
